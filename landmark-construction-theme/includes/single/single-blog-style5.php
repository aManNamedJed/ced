...
$content_class = "col-sm-8 col-md-8 blog-wrapper single-blog-style5 col-md-offset-2"; 
if ( $sidebar_single_style != "no_sidebar" && $sidebar_single_style != "" ) {
    ...
    if ( $sidebar_single_column == "sidebar_4") {
      $content_class ="col-sm-8 col-md-8 blog-wrapper single-blog-style5";
      $sidebar_class ="col-sm-4 col-md-4";
    }
    else {
      $content_class ="col-sm-9 col-md-9 blog-wrapper single-blog-style5";
...
<div class="<?php echo esc_attr($content_class); ?>">
  <div class="bt-blog-posts">
          ...
          <article <?php post_class('post-item') ?>>
            ...
            ?>
              ...
              <div class="blog-content">
                ...
                <div class="blog-meta">
                  <span class="Year"><?php the_time('M d, Y'); ?>|</span>
    ...
    <?php } ?>
      ...
      ?>        
    <div class="prevnext">
      <div class="blog-left"><?php previous_post_link('%link', '<i class="fa fa-long-arrow-left">  </i> Previous Post'); ?></div>
  ...
  <div class="top">
        ...
        <div class="bottom">
          <div class="postcount">
            <span><i class="fa fa-picture-o"></i> <?php the_author_posts(); ?><?php echo esc_html__(' Total Posts', 'landmark-construction-theme'); ?></span>
          </div>
              ...
              <?php
                $authorFacebook = get_the_author_meta('facebook');
                  if( !empty($authorFacebook) ) {
                    ?><div class="authorinline"><a href="<?php echo esc_url($authorFacebook); ?>" target="_blank"><div class="social-facebook"><i class="fa fa-facebook"></i></div></a></div>
                    <?php  
                  }
                  $authorTwitter = get_the_author_meta('twitter');
                  if( !empty($authorTwitter) ) {
                    ?><div class="authorinline"><a href="<?php echo esc_url($authorTwitter); ?>" target="_blank"><div class="social-twitter"><i class="fa fa-twitter"></i></div></a></div>
                    <?php  
                  }
                  $authorPinterest = get_the_author_meta('pinterest');
                  if( !empty($authorPinterest) ) {
                    ?><div class="authorinline"><a href="<?php echo esc_url($authorPinterest); ?>" target="_blank"><div class="social-pinterest"><i class="fa fa-pinterest"></i></div></a></div>
                    <?php 
                  }
                  $authorGooglep = get_the_author_meta('googlep');
                  if( !empty($authorGooglep) ) {
                    ?><div class="authorinline"><a href="<?php echo esc_url($authorGooglep); ?>" target="_blank"><div class="social-google-plus"><i class="fa fa-google-plus"></i></div></a></div><?php 
                  }
                  $authorDribbble = get_the_author_meta('dribbble');
                    if( !empty($authorDribbble) ) {
                    ?><div class="authorinline"><a href="<?php echo esc_url($authorDribbble); ?>" target="_blank"><div class="social-dribbble"><i class="fa fa-dribbble"></i></div></a></div>
                    <?php  
                  }
                  ?>                   
          </div>
