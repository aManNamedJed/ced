...
$content_class = "col-sm-8 col-md-8 blog-wrapper single-blog-style1 col-md-offset-2"; 
if ( $sidebar_single_style != "no_sidebar" && $sidebar_single_style != "" ) {
    ...
    if ( $sidebar_single_column == "sidebar_4") {
      $content_class ="col-sm-8 col-md-8 blog-wrapper single-blog-style1";
      $sidebar_class ="col-sm-4 col-md-4";
    }
    else {
      $content_class ="col-sm-9 col-md-9 blog-wrapper single-blog-style1";
          ...
          <article <?php post_class('post-item') ?>>
            ...
            <div class="blog-over-thumb">
              ...
              <div class="blog-content">
                ...
                <div class="blog-meta">                      
                  <span><?php echo esc_html($byadmin); ?> <?php the_author_posts_link(); ?></span>
