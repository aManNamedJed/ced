...
$content_class = "col-sm-8 col-md-8 blog-wrapper single-blog-style4 col-md-offset-2"; 
if ( $sidebar_single_style != "no_sidebar" && $sidebar_single_style != "" ) {
    ...
    if ( $sidebar_single_column == "sidebar_4") {
      $content_class ="col-sm-8 col-md-8 blog-wrapper single-blog-style4";
      $sidebar_class ="col-sm-4 col-md-4";
    }
    else {
      $content_class ="col-sm-9 col-md-9 blog-wrapper single-blog-style4";
  ...
  <div class="bt-blog-posts">
      ...
      <!-- Loop Start -->
          <article <?php post_class('post-item') ?>>
            ...
            ?>
            <div class="authorover"><?php echo get_avatar( get_the_author_meta('email') , 67 ); ?></div>
            </div> 
            ...
            <div class="blog-over-thumb">
                    ...
                    <div class="blog-icon-box blog-widget-share"><i class="fa fa-share"></i> <?php echo esc_html($share);echo ' '; echo esc_html($sharetext); ?>
              ...
              <div class="blog-content">
                ...
                <?php the_time('j F Y'); ?>
                <span class="bt_blog_title_sep"> . </span>
                <?php echo esc_html($category);echo ' ';the_category('<span>,</span> '); ?>
              </div>
